// Updated App.tsx to restore the 3D dice while keeping reset behavior
  ...
  const handleMoodSelect = (mood: MoodType) => {
    ...
    try {
      ...
      fetch(audioPath)
        ...
        .catch((error) => {
          console.error(`Error fetching audio file: ${audioPath}`, error);
        });
  ...
  🎲 Click the dice to roll a mood!
          ...
          <div className="w-full flex flex-col items-center gap-8">
            {selectedMood && moodResponses[selectedMood] ? (
              <div className={`response-card ${isFlipped ? 'flipped' : ''} backdrop-blur-md bg-gray-900/40 p-6 rounded-2xl border border-gray-700/50 shadow-lg`} style={{ perspective: '1000px' }}>
